...
function Inmuble({ inmuble, estados, municipios }) {

  if (!inmuble || !estados || !municipios) {
          ...
          >
            ...
            <div className="col-12 col-md-8">
              ...
              <span className={`h3 m-1 ${styles['property-price']}`}>
                $ {Number(inmuble.precio).toLocaleString()} MXN
              </span>
              <div className="row mx-4 pt-4">
                <div className="col-12 col-md-12 me-5 pe-4 d-flex flex-column text-center">
                  <div className="row justify-content-between">
                    ...
                    </div><div className={`col-4 col-md-2 gift-m d-flex flex-column align-items-center property-detail  ${styles['top-m']} ${styles['property-detail']}`}>
